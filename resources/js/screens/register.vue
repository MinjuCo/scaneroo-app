        ...
        methods: {
            ...
            validateUsername(str) {
                ...
                if (str == "") {
                    ...
                    this.checkUsername(str).then(() => {
                        this.usernameUnique = this.unique;
                ...
                switch(field) {
                    ...
                    case 'password':
                        if (this.password.trim().length < 6){
                            error = "You must choose a password containing at least 6 characters.";
                        }
                ...
                return this.$http.get('/api/check-username/' + str)
                    .then(response => {
                        if(response.data.code == "AlreadyExists"){
                            ...
                            this.unique = "Username is already in use.";
                        }else{
                            this.unique = "";
                            this.usernameNotValid = true;
                        }
            ...
            setLoginInfo() {
                ...
                setTimeout(() => {
                    if(!this.usernameNotValid && !this.passwordNotValid && !this.emailNotValid){
                        this.$router.push({ name: 'register', params: { step: 'fill-info'} });
                    }
                }, 500);
            ...
            submitRegister() {
                ...
                if(!this.usernameNotValid && !this.emailNotValid && !this.passwordNotValid && !this.nameNotValid && !this.birthdayNotValid) {
